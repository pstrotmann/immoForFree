...
class gsp_immos_organisationlist_gsp extends GroovyPage {
...
printHtmlPart(14)
invokeTag('message','g',32,['code':("organisation.hausadresse.label"),'default':("Hausadresse")],-1)
printHtmlPart(15)
loop:{
int i = 0
...
invokeTag('link','g',40,['action':("show"),'id':(organisationInstance.id)],3)
printHtmlPart(18)
...
printHtmlPart(21)
invokeTag('paginate','g',54,['total':(organisationInstanceTotal)],-1)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1397806596000L
