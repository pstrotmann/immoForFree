...
class gsp_immos_mietvertragcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mietvertrag/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(mietvertragInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(mietvertragInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1396179284000L
