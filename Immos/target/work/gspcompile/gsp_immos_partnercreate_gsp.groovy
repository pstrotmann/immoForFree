...
class gsp_immos_partnercreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(partnerInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(partnerInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
