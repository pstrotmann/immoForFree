...
class gsp_immos_einheitswertcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/einheitswert/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(einheitswertInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(einheitswertInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
