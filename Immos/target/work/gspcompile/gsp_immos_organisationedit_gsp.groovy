...
class gsp_immos_organisationedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(organisationInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(organisationInstance?.version)],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1405945690000L
