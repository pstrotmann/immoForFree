import org.strotmann.immos.Bank
...
class gsp_immos_bankedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/bank/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',27,['bean':(bankInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(bankInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(bankInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:bankInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1411546088000L
