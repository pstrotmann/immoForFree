...
class gsp_immos_matchcodecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/matchcode/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',25,['bean':(matchcodeInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',27,['bean':(matchcodeInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
...
public static final long LAST_MODIFIED = 1394384076000L
