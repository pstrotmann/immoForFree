...
class gsp_immos_hausadresselist_gsp extends GroovyPage {
...
invokeTag('link','g',43,['action':("show"),'id':(hausadresseInstance.id)],3)
printHtmlPart(17)
...
printHtmlPart(19)
invokeTag('paginate','g',58,['total':(hausadresseInstanceTotal)],-1)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1392308476000L
