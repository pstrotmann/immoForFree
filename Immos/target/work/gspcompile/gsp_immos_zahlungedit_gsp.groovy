...
class gsp_immos_zahlungedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/zahlung/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'zahlung.label', default: 'Zahlung'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',27,['bean':(zahlungInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(zahlungInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(zahlungInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(zahlungInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',40,['url':([resource:zahlungInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(25)
})
...
public static final long LAST_MODIFIED = 1420212912000L
