...
class gsp_immos_hausadresseedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/hausadresse/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',27,['bean':(hausadresseInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(hausadresseInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(hausadresseInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(hausadresseInstance?.version)],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1405945542000L
