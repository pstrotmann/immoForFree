...
class gsp_immos_kommunikationedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(kommunikationInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(kommunikationInstance?.version)],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1405945576000L
