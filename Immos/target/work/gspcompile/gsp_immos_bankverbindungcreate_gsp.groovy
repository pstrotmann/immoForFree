...
class gsp_immos_bankverbindungcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(bankverbindungInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(bankverbindungInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1392028826000L
