...
class gsp_immos_umlageanteilcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/umlageanteil/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(umlageanteilInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(umlageanteilInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
