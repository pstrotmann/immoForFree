...
class gsp_immos_offenerPostencreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/offenerPosten/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(offenerPostenInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(offenerPostenInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1397115014000L
