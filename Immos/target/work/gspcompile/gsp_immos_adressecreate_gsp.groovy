...
class gsp_immos_adressecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(adresseInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(adresseInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1391958482000L
