...
<li class="add">
<g:link controller="zwischenzaehler" action="create" params="['zaehler.id': zaehlerInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'zwischenzaehler.label', default: 'Zählerstand')])}</g:link>
</li>
</ul>
